...
<body>
	...
	<div class="container-fluid" id="container_main">
		<div class="row" id="container_main_two">
			<nav class="col-md-2 d-none d-md-block bg-light sidebar" id="containerAdmin">
				<div class="sidebar-sticky">
					<h5 id="nomeAdmin">Ciao</h5>
					<!--Inizia la lista delle scelte per l'admin-->
					<ul class="nav flex-column border-left pl-3">
						<li class="nav-item"><a class="nav-link navListUtenti" href="/gas/utenti.html"> <span
									data-feather="home"></span>
								Utenti <span class="sr-only"></span>
							</a></li>
						<li class="nav-item"><a class="nav-link navListFlusso" href="/gas/flusso.jsp"> <span
									data-feather="file"></span>
								Flusso Giornaliero
							</a></li>
						<li class="nav-item"><a class="nav-link navListNotizie" href="/gas/mappa.html"> <span
									data-feather="shopping-cart"></span>
								Mappa
							</a></li>
						<li class="nav-item"><a class="nav-link navListRecensioni" href="/gas/recensioni.html"> <span
									data-feather="users"></span>
								Recensioni
							</a></li>
						<li class="nav-item"><a class="nav-link navListStatistiche" href="/gas/statistiche.html"> <span
			...
			<main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4" id="containerDatiApp">
				<div
				...
				<div class="border d-flex" id="adminUtils">
					...
					<div class="border d-flex flex-column justify-content-center" id="containerStations">
						<div class="d-flex flex-column-reverse text-center" id="textContainerStations">
						...
						<form id="formUpdateStation" class="pt-3" method="POST"
							...
							<div class="form-group d-flex flex-column">
                                ...
                                carburanti-prezzi-praticati-e-anagrafica-degli-impianti" target="_blank">Scarica
													CSV!</a></span>
										</div>
									</div>
								</div>
								...
								<br>
								<div class="d-flex justify-content-center">
									<p id="msgUploadSuccesfulStation"> ${ messageSuccesfulStation } </p>
									<p id="msgMessageErrorStation"> ${ messageErrorStation } </p>
								</div>
							</div>
						</form>
					</div>
					...
					<div class="border d-flex flex-column" id="containerPrice">
						<div class="d-flex flex-column-reverse text-center" id="textContainerPrice">
							<small>Scegli file CSV da inserire</small>
						...
						<form id="formUpdatePrice" class="pt-3" method="POST"
							...
							<div class="form-group d-flex flex-column">
								...
								<br>
								<div class="d-flex justify-content-center">
									<button id="btnCaricaPrezzo" type="" class="btn btn-primary">Carica</button>
								</div>
								<br>
								<div class="d-flex justify-content-center">
									<p id="msgUploadSuccesfulPrice"> ${ messageSuccesfulPrice } </p>
									<p id="msgMessageErrorPrice"> ${ messageErrorPrice } </p>
								</div>
							</div>
						</form>
					</div>
